...
public class MainMenu extends JPanel {
    ...
    public MainMenu(Game game) {
        ...
        startButton.setPreferredSize(new java.awt.Dimension(240, 60));
        ...
        skinsButton.setPreferredSize(new java.awt.Dimension(100, 42));
        ...
        settingsButton.setPreferredSize(new java.awt.Dimension(160, 42));
        ...
        quitButton.setPreferredSize(new java.awt.Dimension(100, 42));
