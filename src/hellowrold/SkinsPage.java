...
public class SkinsPage extends JPanel {
    ...
    public SkinsPage(Game game) {
        ...
        cycleBackwardButton.setPreferredSize(new java.awt.Dimension(60, 80));
    ...
    // Label for current skin image
       ...
       imagePanel.add(costImageLabel, imageGbc);
        ...
        cycleForwardButton.setPreferredSize(new java.awt.Dimension(60, 80));
        ...
        buyButton.setPreferredSize(new java.awt.Dimension(120, 42));
        ...
        selectButton.setPreferredSize(new java.awt.Dimension(120, 42));
     ...
     // Button to return to the main menu
        ...
        backButton.setPreferredSize(new java.awt.Dimension(100, 42));
